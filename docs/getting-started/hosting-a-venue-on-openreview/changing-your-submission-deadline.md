...
If you want to change your submission deadline, you can do so using the [Revision](../../reference/stages/revision.md) button on the [venue request form](navigating-your-venue-pages.md#venue-request-form).&#x20;
