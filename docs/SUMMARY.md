...
* [Using the API](getting-started/using-the-api/README.md)
  ...
  * [Edges](getting-started/using-the-api/edges/README.md)
    * [Getting all Assignments for a User](getting-started/using-the-api/edges/getting-all-assignments-for-a-user.md)
    * [Posting a custom conflict edge](getting-started/using-the-api/edges/posting-a-custom-conflict-edge.md)
  * [Groups](getting-started/using-the-api/groups/README.md)
    * [Copying Members from One Group to Another](getting-started/using-the-api/groups/copying-members-from-one-group-to-another.md)
    * [Get all Venues](getting-started/using-the-api/groups/get-all-venues.md)
  * [Notes](getting-started/using-the-api/notes/README.md)
    * [Posting a Support Request Form](getting-started/using-the-api/notes/posting-a-support-request-form.md)
    * [Getting all Reviews](getting-started/using-the-api/notes/getting-all-reviews.md)
    * [Getting all MetaReviews](getting-started/using-the-api/notes/getting-all-metareviews.md)
    * [Getting all Decisions](getting-started/using-the-api/notes/getting-all-decisions.md)
    * [Exporting all Reviews into a CSV](getting-started/using-the-api/notes/exporting-all-reviews-into-a-csv.md)
  * [Invitations](getting-started/using-the-api/invitations/README.md)
    * [Changing the Expiration Date of the Submission Invitation](getting-started/using-the-api/invitations/changing-the-expiration-date-of-the-submission-invitation.md)
